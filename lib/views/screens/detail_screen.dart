...
class Detail extends StatelessWidget {
  ...
  //   return list;
  // }
  Widget _Detail(List<Restaurant> data) {
    Restaurant dataRestaurant = data.where((restaurant) => restaurant.id == Get.parameters['id']).toList()[0];
  ...
  Widget build(BuildContext context) {
    ...
    // );
    // Restaurant dataRestaurant = controller.search(Get.parameters['id'] ?? 'rqdv5juczeskfw1e867').then((data));

    // Restaurant dataRestaurant = controller.search(Get.parameters['id'] ?? 'rqdv5juczeskfw1e867');
    // print(dataRestaurant.name);
    return Scaffold(
        body: controller.obx(
          (data) => _Detail(data),
