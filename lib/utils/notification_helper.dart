...
class NotificationHelper {
  ...
  Future<void> showNotification(
    ...
    var titleNotif = resto.restaurants[0].name;
  ...
  void configureSelectNotificationSubject() {
    selectNotificationSubject.stream.listen(
        ...
        var data = ListResponse.fromJson(json.decode(payload));
        var resto = data.restaurants[0];
        Navigation.intentWithData('/detail/${resto.id}', Get.isDarkMode ? Colors.black : Colors.white);
      },
    );
  }
}